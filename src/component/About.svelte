...
<section class="h-auto md:h-screen">
	...
	<div class="max-w-full md:max-w-md">
		<p class="font-serif text-gray-500">
			...
			dis parturient montes, nascetur ridiculus mus. Praesent euismod faucibus risus tempor eleifend.
			Proin molestie, sem sit amet iaculis fermentum, orci nisi commodo dolor, eget tincidunt tellus
			nulla id nisl. Proin id justo sed risus lobortis viverra ut porttitor libero. Pellentesque felis
			augue, sollicitudin quis mauris at, consectetur ullamcorper lorem.
		</p>
	</div>
</section>
